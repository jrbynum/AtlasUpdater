...
namespace AtlasUpdater.Interfaces
{
	abstract class SteamInterface
	{
		...
		public SteamInterface(AtlasUpdater parent)
		{
			this._Parent = parent;
		}
	...
	{
		public SteamInterfaceWindows(AtlasUpdater parent) : base(parent) {}
		...
		{
			string ManifestPath = string.Format("{0}\\steamapps\\appmanifest_1006030.acf", ApplicationPath);
			string KVData = null;
	...
	{
		public SteamInterfaceUnix(AtlasUpdater parent) : base(parent) {}
