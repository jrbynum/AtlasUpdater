...
namespace AtlasUpdater.Classes
{
	...
	class SteamKit : IDisposable
	{
		...
		public static ThreadPair SpawnThread(AtlasUpdater p, AutoResetEvent r)
		{
		...
		#region Thread Setup
		public SteamKit(AtlasUpdater p, AutoResetEvent r)
		{
			this._Parent = p;
			this._ResetEvent = r;
